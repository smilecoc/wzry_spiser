...
# -*- coding: utf-8 -*-
# @Time    : 2019/12/27 16:32
# @Author  : kevin shu
# @FileName: spider_photo.py
# @Software: PyCharm
...
headers = {'User-Agent':'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/79.0.3945.88 Safari/537.36'} # 添加用户代理
...
try:
    ...
    for m in range(len(json_list)):
        ...
        for i in range(1, skin_count + 1):
            ...
            with open('wzpic/' + hero_name + ' - ' + skin_name[i - 1] + '.jpg', 'wb') as f:
                f.write(picture)
